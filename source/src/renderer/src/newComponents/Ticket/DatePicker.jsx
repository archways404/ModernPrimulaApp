	...
	return (
		<div
			...
			<div className="flex flex-col items-center space-y-4">
				<div className="w-72 h-72 bg-zinc-900 rounded-lg overflow-hidden text-gray-200">
					...
					<div className="grid grid-cols-3 gap-4 p-4 bg-zinc-900">
						<button
							...
							value="01"
							className="bg-zinc-900 pt-1 pb-1 text-white rounded-md border border-white hover:border-green-500 hover:text-green-500">
							Jan
						</button>
						<button
							onClick={handleSubmit}
