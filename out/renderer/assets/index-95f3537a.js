...
function R$2(a, b2, e2, d2, c2) {
  ...
  if (h2)
    return h2 = a, c2 = c2(h2), a = "" === d2 ? "." + Q$3(h2, 0) : d2, I$3(c2) ? (e2 = "", null != a && (e2 = a.replace(P$2, "$&/") + "/"), R$2(c2, b2, e2, "", function(a2) {
      return a2;
    })) : null != c2 && (O$2(c2) && (c2 = N$3(c2, e2 + (!c2.key || h2 && h2.key === c2.key ? "" : ("" + c2.key).replace(P$2, "$&/") + "/") + a)), b2.push(c2)), 1;
  h2 = 0;
  d2 = "" === d2 ? "." : d2 + ":";
  if (I$3(a))
 ...
 * LICENSE file in the root directory of this source tree.
 */
var f$2 = reactExports, k$3 = Symbol.for("react.element"), l$1 = Symbol.for("react.fragment"), m$4 = Object.prototype.hasOwnProperty, n$1 = f$2.__SECRET_INTERNALS_DO_NOT_USE_OR_YOU_WILL_BE_FIRED.ReactCurrentOwner, p$3 = { key: true, ref: true, __self: true, __source: true };
...
function ni(a, b2, c2) {
  ...
  b2 = N$2.updateQueue;
  null === b2 ? (b2 = { lastEffect: null, stores: null }, N$2.updateQueue = b2, b2.stores = [a]) : (c2 = b2.stores, null === c2 ? b2.stores = [a] : c2.push(a));
}
...
function li(a, b2, c2, d2) {
  ...
  b2 = N$2.updateQueue;
  null === b2 ? (b2 = { lastEffect: null, stores: null }, N$2.updateQueue = b2, b2.lastEffect = a.next = a) : (c2 = b2.lastEffect, null === c2 ? b2.lastEffect = a.next = a : (d2 = c2.next, c2.next = a, a.next = d2, b2.lastEffect = a));
  return a;
}
function si() {
...
function Di(a, b2, c2) {
  ...
  He(c2, b2) || (c2 = yc(), N$2.lanes |= c2, hh |= c2, a.baseState = true);
  return b2;
}
function Ei(a, b2) {
  var c2 = C$2;
...
function Fj(a, b2, c2) {
  ...
  switch (b2.tag) {
    ...
    case 13:
      ...
      d2 = null !== d2;
      d2 !== (null !== a && null !== a.memoizedState) && d2 && (b2.child.flags |= 8192, 0 !== (b2.mode & 1) && (null === a || 0 !== (M$2.current & 1) ? 0 === T$2 && (T$2 = 3) : uj()));
      null !== b2.updateQueue && (b2.flags |= 4);
      S$2(b2);
      return null;
    case 4:
      return Jh(), Bj(a, b2), null === a && sf(b2.stateNode.containerInfo), S$2(b2), null;
    case 10:
    ...
    case 22:
    case 23:
      return Ij(), d2 = null !== b2.memoizedState, null !== a && null !== a.memoizedState !== d2 && (b2.flags |= 8192), d2 && 0 !== (b2.mode & 1) ? 0 !== (gj & 1073741824) && (S$2(b2), b2.subtreeFlags & 6 && (b2.flags |= 8192)) : S$2(b2), null;
    case 24:
      return null;
    case 25:
      return null;
...
var mk = Math.ceil, nk = ua.ReactCurrentDispatcher, ok = ua.ReactCurrentOwner, pk = ua.ReactCurrentBatchConfig, K$1 = 0, R$1 = null, Y$1 = null, Z$1 = 0, gj = 0, fj = Uf(0), T$2 = 0, qk = null, hh = 0, rk = 0, sk = 0, tk = null, uk = null, gk = 0, Hj = Infinity, vk = null, Pi = false, Qi = null, Si = null, wk = false, xk = null, yk = 0, zk = 0, Ak = null, Bk = -1, Ck = 0;
function L$2() {
...
function mh(a, b2, c2, d2) {
  ...
  Ac(a, c2, d2);
  if (0 === (K$1 & 2) || a !== R$1)
    a === R$1 && (0 === (K$1 & 2) && (rk |= c2), 4 === T$2 && Dk(a, Z$1)), Ek(a, d2), 1 === c2 && 0 === K$1 && 0 === (b2.mode & 1) && (Hj = B$2() + 500, fg && jg());
}
function Ek(a, b2) {
...
function Ui(a, b2, c2) {
  ...
  R$1 === a && (Z$1 & c2) === c2 && (4 === T$2 || 3 === T$2 && (Z$1 & 130023424) === Z$1 && 500 > B$2() - gk ? Lk(a, 0) : sk |= c2);
  Ek(a, b2);
}
function Zk(a, b2) {
...
const u = (t2) => "number" == typeof t2 && !isNaN(t2), d$1 = (t2) => "string" == typeof t2, p$1 = (t2) => "function" == typeof t2, m$2 = (t2) => d$1(t2) || p$1(t2) ? t2 : null, f$1 = (t2) => reactExports.isValidElement(t2) || d$1(t2) || p$1(t2) || u(t2);
function g$2(t2, e2, n2) {
  void 0 === n2 && (n2 = 300);
...
function h$1(e2) {
  let { enter: a, exit: r2, appendPosition: i = false, collapse: l2 = true, collapseDuration: c2 = 300 } = e2;
  return function(e3) {
    ...
    return reactExports.useLayoutEffect(() => {
      ...
      const t2 = f2.current, e4 = () => {
        t2.removeEventListener("animationend", e4), l2 ? g$2(t2, m2, c2) : m2();
      };
...
const v$2 = { list: /* @__PURE__ */ new Map(), emitQueue: /* @__PURE__ */ new Map(), on(t2, e2) {
  ...
  return React.createElement(T$1, { ...e2 }, React.createElement("path", { d: "M12 0a12 12 0 1012 12A12.013 12.013 0 0012 0zm.25 5a1.5 1.5 0 11-1.5 1.5 1.5 1.5 0 011.5-1.5zm2.25 13.5h-4a1 1 0 010-2h.75a.25.25 0 00.25-.25v-4.5a.25.25 0 00-.25-.25h-.75a1 1 0 010-2h1a2 2 0 012 2v4.75a.25.25 0 00.25.25h.75a1 1 0 110 2z" }));
}, warning: function(e2) {
  return React.createElement(T$1, { ...e2 }, React.createElement("path", { d: "M23.32 17.191L15.438 2.184C14.728.833 13.416 0 11.996 0c-1.42 0-2.733.833-3.443 2.184L.533 17.448a4.744 4.744 0 000 4.368C1.243 23.167 2.555 24 3.975 24h16.05C22.22 24 24 22.044 24 19.632c0-.904-.251-1.746-.68-2.44zm-9.622 1.46c0 1.033-.724 1.823-1.698 1.823s-1.698-.79-1.698-1.822v-.043c0-1.028.724-1.822 1.698-1.822s1.698.79 1.698 1.822v.043zm.039-12.285l-.84 8.06c-.057.581-.408.943-.897.943-.49 0-.84-.367-.896-.942l-.84-8.065c-.057-.624.25-1.095.779-1.095h1.91c.528.005.84.476.784 1.1z" }));
}, success: function(e2) {
  return React.createElement(T$1, { ...e2 }, React.createElement("path", { d: "M12 0a12 12 0 1012 12A12.014 12.014 0 0012 0zm6.927 8.2l-6.845 9.289a1.011 1.011 0 01-1.43.188l-4.888-3.908a1 1 0 111.25-1.562l4.076 3.261 6.227-8.451a1 1 0 111.61 1.183z" }));
}, error: function(e2) {
  return React.createElement(T$1, { ...e2 }, React.createElement("path", { d: "M11.983 0a12.206 12.206 0 00-8.51 3.653A11.8 11.8 0 000 12.207 11.779 11.779 0 0011.8 24h.214A12.111 12.111 0 0024 11.791 11.766 11.766 0 0011.983 0zM10.5 16.542a1.476 1.476 0 011.449-1.53h.027a1.527 1.527 0 011.523 1.47 1.475 1.475 0 01-1.449 1.53h-.027a1.529 1.529 0 01-1.523-1.47zM11 12.5v-6a1 1 0 012 0v6a1 1 0 11-2 0z" }));
}, spinner: function() {
...
function C$1(t2) {
  ...
  function L2(t3, n2) {
    ...
    const M2 = { ...b3, style: b3.toastStyle, key: C2.toastKey++, ...Object.fromEntries(Object.entries(i).filter((t4) => {
      ...
      const t4 = y$2(h2.get(l3), "removed");
      h2.delete(l3), v$2.emit(4, t4);
    ...
    M2.iconOut = function(t4) {
      ...
      return false === r3 || (p$1(r3) ? i2 = r3(l4) : reactExports.isValidElement(r3) ? i2 = reactExports.cloneElement(r3, l4) : d$1(r3) || u(r3) ? i2 = r3 : s2 ? i2 = E$1.spinner() : ((t5) => t5 in E$1)(o2) && (i2 = E$1[o2](l4))), i2;
    }(M2), p$1(i.onOpen) && (M2.onOpen = i.onOpen), p$1(i.onClose) && (M2.onClose = i.onClose), M2.closeButton = b3.closeButton, false === i.closeButton || f$1(i.closeButton) ? M2.closeButton = i.closeButton : true === i.closeButton && (M2.closeButton = !f$1(b3.closeButton) || b3.closeButton);
    let x2 = t3;
    reactExports.isValidElement(t3) && !d$1(t3.type) ? x2 = reactExports.cloneElement(t3, { closeToast: L3, toastProps: M2, data: T3 }) : p$1(t3) && (x2 = t3({ closeToast: L3, toastProps: M2, data: T3 })), b3.limit && b3.limit > 0 && C2.count > b3.limit && N2 ? C2.queue.push({ toastContent: x2, toastProps: M2, staleId: r2 }) : u(s) ? setTimeout(() => {
      O2(x2, M2, r2);
    }, s) : O2(x2, M2, r2);
  }
  function O2(t3, e2, n2) {
    ...
    h2.set(o2, s), c2((t4) => [...t4, o2].filter((t5) => t5 !== n2)), v$2.emit(4, y$2(s, null == s.props.updateId ? "added" : "updated"));
  }
  return reactExports.useEffect(() => (C2.containerId = t2.containerId, v$2.cancelEmit(3).on(0, L2).on(1, (t3) => g2.current && I2(t3)).on(5, b2).emit(2, C2), () => {
    h2.clear(), v$2.emit(3, C2);
  }), []), reactExports.useEffect(() => {
...
function _$1(t2) {
  ...
  function v2(e2) {
    if (t2.draggable) {
      ...
      const n2 = c2.current;
      u2.canCloseOnClick = true, u2.canDrag = true, u2.boundingRect = n2.getBoundingClientRect(), n2.style.transition = "", u2.x = b$2(e2.nativeEvent), u2.y = I$1(e2.nativeEvent), "x" === t2.draggableDirection ? (u2.start = u2.x, u2.removalDistance = n2.offsetWidth * (t2.draggablePercent / 100)) : (u2.start = u2.y, u2.removalDistance = n2.offsetHeight * (80 === t2.draggablePercent ? 1.5 * t2.draggablePercent : t2.draggablePercent / 100));
    }
  }
  function T2(e2) {
    if (u2.boundingRect) {
      const { top: n2, bottom: o2, left: s, right: a2 } = u2.boundingRect;
      "touchend" !== e2.nativeEvent.type && t2.pauseOnHover && u2.x >= s && u2.x <= a2 && u2.y >= n2 && u2.y <= o2 ? C2() : E2();
    }
  }
  function E2() {
    a(true);
  ...
  function _2(e2) {
    const n2 = c2.current;
    u2.canDrag && n2 && (u2.didMove = true, o && C2(), u2.x = b$2(e2), u2.y = I$1(e2), u2.delta = "x" === t2.draggableDirection ? u2.x - u2.start : u2.y - u2.start, u2.start !== u2.x && (u2.canCloseOnClick = false), n2.style.transform = `translate${t2.draggableDirection}(${u2.delta}px)`, n2.style.opacity = "" + (1 - Math.abs(u2.delta / u2.removalDistance)));
  }
  function L2() {
  ...
  reactExports.useEffect(() => {
    d2.current = t2;
  }), reactExports.useEffect(() => (c2.current && c2.current.addEventListener("d", E2, { once: true }), p$1(t2.onOpen) && t2.onOpen(reactExports.isValidElement(t2.children) && t2.children.props), () => {
    const t3 = d2.current;
...
function O(e2) {
  let { delay: n2, isRunning: o, closeToast: s, type: a = "default", hide: r2, className: i, style: l2, controlledProgress: u2, progress: d2, rtl: m2, isIn: f2, theme: g2 } = e2;
...
const N$1 = (n2) => {
  const { isRunning: o, preventExitTransition: s, toastRef: r2, eventHandlers: i } = _$1(n2), { closeButton: l2, children: u2, autoClose: d2, onClick: m2, type: f2, hideProgressBar: g2, closeToast: h2, transition: y2, position: v2, className: T2, style: E2, bodyClassName: C2, bodyStyle: b2, progressClassName: I2, progressStyle: N2, updateId: M2, role: R2, progress: w2, rtl: x2, toastId: $2, deleteToast: k2, isIn: P2, isLoading: B2, iconOut: D2, closeOnClick: A2, theme: z2 } = n2, F2 = clsx("Toastify__toast", `Toastify__toast-theme--${z2}`, `Toastify__toast--${f2}`, { "Toastify__toast--rtl": x2 }, { "Toastify__toast--close-on-click": A2 }), H2 = p$1(T2) ? T2({ rtl: x2, position: v2, type: f2, defaultClassName: F2 }) : clsx(F2, T2), S2 = !!w2 || !d2, q2 = { closeToast: h2, type: f2, theme: z2 };
  let Q2 = null;
  return false === l2 || (Q2 = p$1(l2) ? l2(q2) : reactExports.isValidElement(l2) ? reactExports.cloneElement(l2, q2) : L$1(q2)), React.createElement(y2, { isIn: P2, done: k2, position: v2, preventExitTransition: s, nodeRef: r2 }, React.createElement("div", { id: $2, onClick: m2, className: H2, ...i, style: E2, ref: r2 }, React.createElement("div", { ...P2 && { role: R2 }, className: p$1(C2) ? C2({ type: f2 }) : clsx("Toastify__toast-body", C2), style: b2 }, null != D2 && React.createElement("div", { className: clsx("Toastify__toast-icon", { "Toastify--animate-icon Toastify__zoom-enter": !B2 }) }, D2), React.createElement("div", null, u2)), Q2, React.createElement(O, { ...M2 && !S2 ? { key: `pb-${M2}` } : {}, rtl: x2, theme: z2, delay: d2, isRunning: o, isIn: P2, closeToast: h2, hide: g2, type: f2, style: N2, className: I2, controlledProgress: S2, progress: w2 || 0 })));
}, M$1 = function(t2, e2) {
...
}, R = h$1(M$1("bounce", true));
h$1(M$1("slide", true));
h$1(M$1("zoom"));
h$1(M$1("flip"));
const k$2 = reactExports.forwardRef((e2, n2) => {
  const { getToastToRender: o, containerRef: a, isToastActive: r2 } = C$1(e2), { className: i, style: l2, rtl: u2, containerId: d2 } = e2;
  function f2(t2) {
    const e3 = clsx("Toastify__toast-container", `Toastify__toast-container--${t2}`, { "Toastify__toast-container--rtl": u2 });
    return p$1(i) ? i({ position: t2, rtl: u2, defaultClassName: e3 }) : clsx(e3, m$2(i));
  }
  return reactExports.useEffect(() => {
    n2 && (n2.current = a.current);
  }, []), React.createElement("div", { ref: a, className: "Toastify", id: d2 }, o((e3, n3) => {
    const o2 = n3.length ? { ...l2 } : { ...l2, pointerEvents: "none" };
    return React.createElement("div", { className: f2(e3), style: o2, key: `container-${e3}` }, n3.map((e4, o3) => {
      let { content: s, props: a2 } = e4;
      return React.createElement(N$1, { ...a2, isIn: r2(a2.toastId), style: { ...a2.style, "--nth": o3 + 1, "--len": n3.length }, key: `toast-${a2.key}` }, s);
    }));
  }));
});
k$2.displayName = "ToastContainer", k$2.defaultProps = { position: "top-right", transition: R, autoClose: 5e3, closeButton: L$1, pauseOnHover: true, pauseOnFocusLoss: true, closeOnClick: true, draggable: true, draggablePercent: 80, draggableDirection: "x", role: "alert", theme: "light" };
let P, B$1 = /* @__PURE__ */ new Map(), D$1 = [], A$1 = 1;
function z$2() {
  return "" + A$1++;
}
function F$1(t2) {
  return t2 && (d$1(t2.toastId) || u(t2.toastId)) ? t2.toastId : z$2();
}
function H$1(t2, e2) {
  return B$1.size > 0 ? v$2.emit(0, t2, e2) : D$1.push({ content: t2, options: e2 }), e2.toastId;
}
function S$1(t2, e2) {
  return { ...e2, type: e2 && e2.type || t2, toastId: F$1(e2) };
}
function q$2(t2) {
  return (e2, n2) => H$1(e2, S$1(t2, n2));
}
function Q$1(t2, e2) {
  return H$1(t2, S$1("default", e2));
}
Q$1.loading = (t2, e2) => H$1(t2, S$1("default", { isLoading: true, autoClose: false, closeOnClick: false, closeButton: false, draggable: false, ...e2 })), Q$1.promise = function(t2, e2, n2) {
  let o, { pending: s, error: a, success: r2 } = e2;
  s && (o = d$1(s) ? Q$1.loading(s, n2) : Q$1.loading(s.render, { ...n2, ...s }));
  const i = { isLoading: null, autoClose: null, closeOnClick: null, closeButton: null, draggable: null }, l2 = (t3, e3, s2) => {
    if (null == e3)
      return void Q$1.dismiss(o);
    const a2 = { type: t3, ...i, ...n2, data: s2 }, r3 = d$1(e3) ? { render: e3 } : e3;
    return o ? Q$1.update(o, { ...a2, ...r3 }) : Q$1(r3.render, { ...a2, ...r3 }), s2;
  }, c2 = p$1(t2) ? t2() : t2;
  return c2.then((t3) => l2("success", r2, t3)).catch((t3) => l2("error", a, t3)), c2;
}, Q$1.success = q$2("success"), Q$1.info = q$2("info"), Q$1.error = q$2("error"), Q$1.warning = q$2("warning"), Q$1.warn = Q$1.warning, Q$1.dark = (t2, e2) => H$1(t2, S$1("default", { theme: "dark", ...e2 })), Q$1.dismiss = (t2) => {
  B$1.size > 0 ? v$2.emit(1, t2) : D$1 = D$1.filter((e2) => null != t2 && e2.options.toastId !== t2);
}, Q$1.clearWaitingQueue = function(t2) {
  return void 0 === t2 && (t2 = {}), v$2.emit(5, t2);
}, Q$1.isActive = (t2) => {
  let e2 = false;
  return B$1.forEach((n2) => {
  ...
  void 0 === e2 && (e2 = {}), setTimeout(() => {
    const n2 = function(t3, e3) {
      ...
      const o = B$1.get(n3 || P);
      return o && o.getToast(t3);
    }(t2, e2);
    if (n2) {
      const { props: o, content: s } = n2, a = { delay: 100, ...o, ...e2, toastId: e2.toastId || t2, updateId: z$2() };
      a.toastId !== t2 && (a.staleId = t2);
      const r2 = a.render || s;
      delete a.render, H$1(r2, a);
    }
  }, 0);
}, Q$1.done = (t2) => {
  Q$1.update(t2, { progress: 1 });
}, Q$1.onChange = (t2) => (v$2.on(4, t2), () => {
  v$2.off(4, t2);
}), Q$1.POSITION = { TOP_LEFT: "top-left", TOP_RIGHT: "top-right", TOP_CENTER: "top-center", BOTTOM_LEFT: "bottom-left", BOTTOM_RIGHT: "bottom-right", BOTTOM_CENTER: "bottom-center" }, Q$1.TYPE = { INFO: "info", SUCCESS: "success", WARNING: "warning", ERROR: "error", DEFAULT: "default" }, v$2.on(2, (t2) => {
  P = t2.containerId || t2, B$1.set(P, t2), D$1.forEach((t3) => {
    v$2.emit(0, t3.content, t3.options);
  }), D$1 = [];
}).on(3, (t2) => {
  B$1.delete(t2.containerId || t2), 0 === B$1.size && v$2.off(0).off(1).off(5);
});
const ReactToastify = "";
const Welcome = () => {
    ...
    try {
      ...
      if (response.ok) {
        ...
        if (isValid) {
          ...
          Q$1.error("Failed", {
            position: Q$1.POSITION.TOP_CENTER
          });
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    statusMessage && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full fixed top-0 z-50", children: Object.entries(statusMessage).map(([key, message]) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-gray-400 text-bold", children: [
            "Last updated: ",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(k$2, {}),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-9xl font-bold tracking-tighter", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500", children: "M" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-500", children: "o" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-500", children: "d" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-500", children: "e" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-indigo-500", children: "r" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-500", children: "n" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-pink-500", children: "P" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500", children: "r" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-500", children: "i" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-500", children: "m" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-500", children: "u" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-indigo-500", children: "l" }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-purple-500", children: "a" })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("form", { onSubmit: handleSubmit, className: "w-full max-w-md mt-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex items-center border-b border-green-500 py-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "input",
              {
                name: "productKey",
...
const { ipcRenderer: ipcRenderer$4 } = window.require("electron");
const UpdateCheck = () => {
  reactExports.useEffect(() => {
    ipcRenderer$4.on("update_available", () => {
      ipcRenderer$4.removeAllListeners("update_available");
    });
    ipcRenderer$4.on("update_downloaded", () => {
      ipcRenderer$4.removeAllListeners("update_downloaded");
    });
  }, []);
  const restartApp = () => {
    ipcRenderer$4.send("restart_app");
  };
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center min-h-screen bg-gray-800 text-center pt-20 pr-10 pl-20", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    "button",
    {
      className: "mt-8 bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-4 rounded",
      onClick: restartApp,
      children: "Restart and install updates"
    }
  ) }) });
};
const Home = () => {
  const navigate = useNavigate();
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen bg-gray-800 text-center pt-20 pr-10 pl-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-6xl font-bold tracking-tighter mb-10", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-red-500", children: "M" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-yellow-500", children: "o" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-green-500", children: "d" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-blue-500", children: "e" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center space-y-4", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-blue-500 text-black w-32 h-8 rounded-b-3xl", children: "Coming Soon..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-indigo-500 text-black w-32 h-8 rounded-tl-3xl rounded-br-3xl", children: "Coming Soon..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx("button", { className: "bg-purple-500 text-black w-32 h-8 rounded-tr-3xl rounded-bl-3xl", children: "Coming Soon..." }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(UpdateCheck, {})
    ] })
  ] });
};
const AutomaticForm = () => {
  const [formName, setFormName] = reactExports.useState("");
  const [formSalary, setFormSalary] = reactExports.useState("");
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSubmit, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center space-y-4", children: [
    " ",
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      "input",
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("button", { type: "submit", className: "bg-green-500 text-white w-32 rounded-full", children: "Submit" })
  ] }) });
};
const DateForm = () => {
  let navigate = useNavigate();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    "div",
    {
      ...
      children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center space-y-4", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-72 h-72 bg-gray-800 rounded-lg overflow-hidden shadow-lg text-gray-200", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "text-center p-4", children: /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "text-lg font-medium", children: "Select Month" }) }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid grid-cols-3 gap-4 p-4 bg-gray-800", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
...
const UserCredentials = () => {
  const [formUsername, setFormUsername] = reactExports.useState("");
  ...
  const handleSubmit = async (e2) => {
    ...
    try {
      ipcRenderer$3.send("start-verifyLoginDetails-task", {
...
const Automatic = () => {
  ...
  const [displayLoginForm, setDisplayLoginForm] = reactExports.useState(!username || !password);
  const [displayInputForm, setDisplayInputForm] = reactExports.useState(
    username && password && (!name || !salary)
  );
  reactExports.useEffect(() => {
    ipcRenderer$2.on("verifyLoginDetails-task-complete", (event, arg) => {
      console.log(arg);
    ...
    return () => {
      ipcRenderer$2.removeAllListeners("verifyLoginDetails-task-complete");
    };
  }, []);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen bg-gray-800 text-center pt-20 pr-10 pl-20", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-6xl font-bold tracking-tighter mb-10", children: [
    ...
    displayLoginForm ? /* @__PURE__ */ jsxRuntimeExports.jsx(UserCredentials, {}) : displayInputForm ? /* @__PURE__ */ jsxRuntimeExports.jsx(AutomaticForm, {}) : /* @__PURE__ */ jsxRuntimeExports.jsx(DateForm, {})
  ] });
};
...
function ColorRing(_a) {
  ...
  return !visible ? null : React.createElement(
    "svg",
    __assign$3({ xmlns: "http://www.w3.org/2000/svg", xmlnsXlink: "http://www.w3.org/1999/xlink", width, height, viewBox: "0 0 100 100", preserveAspectRatio: "xMidYMid", className: wrapperClass, style: wrapperStyle, "aria-label": ariaLabel, "data-testid": "color-ring-svg" }, DEFAULT_WAI_ARIA_ATTRIBUTE),
    React.createElement(
      "defs",
      null,
      React.createElement(
...
const EditDatesForm = () => {
  const [inputGroups, setInputGroups] = reactExports.useState([]);
  const [renderForm, setRenderForm] = reactExports.useState(true);
  const [renderMFA, setRenderMFA] = reactExports.useState(false);
  const [mfaCode, setMfaCode] = reactExports.useState("");
  const [renderEMP, setRenderEMP] = reactExports.useState(false);
  const [empOptions, setEmpOptions] = reactExports.useState([]);
  const [empSelected, setEmpSelected] = reactExports.useState(null);
  const [showLoading, setShowLoading] = reactExports.useState(false);
  reactExports.useEffect(() => {
    setShowLoading(true);
    ipcRenderer$1.on("fetchSchedule-task-complete", (event, arg) => {
      console.log(arg);
    ...
    return () => {
      ipcRenderer$1.removeAllListeners("fetchSchedule-task-complete");
    };
  }, []);
  const handleAddEntry = () => {
    setInputGroups([...inputGroups, { Date: "", Hours: "" }]);
  };
  const handleInputChange = (index2, field, value) => {
    const updatedGroups = [...inputGroups];
    updatedGroups[index2][field] = value;
  ...
  const handleSubmit = () => {
    ...
    const salary = localStorage.getItem("salary");
    ipcRenderer$1.send("start-formSubmit-task", {
      data: inputGroups,
      username,
      password,
      month,
  ...
  const handleDelete = (index2) => {
    const updatedGroups = inputGroups.filter((_2, i) => i !== index2);
    setInputGroups(updatedGroups);
  };
  reactExports.useEffect(() => {
    ...
    ipcRenderer$1.on("MFA", handleMFA);
    return () => {
      ipcRenderer$1.removeListener("MFA", handleMFA);
    };
  }, []);
  reactExports.useEffect(() => {
    ...
    ipcRenderer$1.on("EMP", handleEMP);
    return () => {
      ipcRenderer$1.removeListener("EMP", handleEMP);
    };
  }, []);
  const handleEmpSelectionChange = (e2) => {
    console.log("Selected value:", e2.target.value);
    setEmpSelected(e2.target.value);
  };
  const EMPhandleSubmit = async (e2) => {
    e2.preventDefault();
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-col items-center justify-center min-h-screen", children: showLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
    ColorRing,
    {
      visible: true,
      height: "80",
    ...
    renderForm && /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { children: inputGroups.map((group, index2) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-4 mb-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-gray-200", children: "Date" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
            ...
            value: group.Date,
            onChange: (e2) => handleInputChange(index2, "Date", e2.target.value)
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-gray-200", children: "Hours" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "input",
          {
            type: "text",
            className: "w-24 h-12 px-4 rounded-md bg-gray-900 text-gray-200",
            value: group.Hours,
            onChange: (e2) => handleInputChange(index2, "Hours", e2.target.value)
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      renderMFA && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-2xl font-bold tracking-tighter mb-10", children: "MFA" }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("h1", { className: "text-white text-4xl font-bold tracking-tighter mb-10", children: mfaCode })
      ] }),
      renderEMP && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "select",
          {
            className: "w-64 h-12 px-4 rounded-md bg-gray-900 text-gray-200",
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("option", { selected: true, value: "", disabled: true, children: "Select option" }),
              empOptions.map((option) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: option.value, children: option.displayText }, option.value))
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
...
const Primulafunction = () => {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen bg-gray-800 text-center pt-20 pr-10 pl-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(EditDatesForm, {})
  ] });
};
const Editlogin = () => {
  const [formUsername, setFormUserame] = reactExports.useState("");
  const [formPassword, setFormPassword] = reactExports.useState("");
  const [showLoading, setShowLoading] = reactExports.useState(false);
  const handleChangeUsername = (event) => {
  ...
  const handleSubmit = async (e2) => {
    ...
    try {
      ...
      if (response.status === 200) {
        ...
        setShowLoading(false);
        Q$1.success("Data successfully updated!", {
          position: Q$1.POSITION.TOP_CENTER
        });
      } else {
        setShowLoading(false);
        console.log("Login failed");
        Q$1.error("Failed to update data.", {
          position: Q$1.POSITION.TOP_CENTER
        });
      }
    } catch (error) {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center space-y-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(k$2, {}),
    showLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ColorRing,
      {
        visible: true,
        height: "80",
    ...
    ) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("form", { onSubmit: handleSubmit, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center space-y-4", children: [
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-white", children: "Edit Login" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          className: "w-64 h-12 px-4 rounded-md bg-gray-900 text-gray-200",
...
const EditnameSalary = () => {
  ...
  const [formName, setFormName] = reactExports.useState(storedName || "");
  const [formSalary, setFormSalary] = reactExports.useState(storedSalary || "");
  const [showLoading, setShowLoading] = reactExports.useState(false);
  const handleChangeName = (event) => {
    setFormName(event.target.value);
  };
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center space-y-4", children: [
    ...
    showLoading ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "loading-screen", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
      ...
      " ",
      /* @__PURE__ */ jsxRuntimeExports.jsx("label", { className: "text-white", children: "Edit Information" }),
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "input",
        {
          className: "w-64 h-12 px-4 rounded-md bg-gray-900 text-gray-200",
...
const Settings = () => {
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center justify-center min-h-screen bg-gray-800 text-center pt-20 pr-10 pl-20", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center space-y-4", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(Editlogin, {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx("br", {}),
      /* @__PURE__ */ jsxRuntimeExports.jsx(EditnameSalary, {})
    ] })
  ] });
};
const index = "";
...
root.render(
  /* @__PURE__ */ jsxRuntimeExports.jsx(React.StrictMode, { children: /* @__PURE__ */ jsxRuntimeExports.jsx(HashRouter, { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(Routes, { children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/automatic", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Automatic, {}) }),
    /* @__PURE__ */ jsxRuntimeExports.jsx(Route, { path: "/primulafunction", element: /* @__PURE__ */ jsxRuntimeExports.jsx(Primulafunction, {}) }),
